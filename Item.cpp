...
void Item::InitItem(int i)
{
	...
	{
		type = TYPE_CURE;
		LoadDivGraph("Data/textures/Item/Cure/CURE_ITEM.png", ITEM_CURE_DIV, ITEM_CURE_DIV, 1, ITEM_W, ITEM_H, cureItem);
        LoadDivGraph("Data/Textures/Item/Cure/CURE_EFFECT.png", 6, 3, 2, ITEM_W, ITEM_H, cureEffect);
	...
	{
		type = TYPE_SCORE;
		LoadDivGraph("Data/textures/Item/Score/SCORE_ITEM.png", ITEM_SCORE_DIV, ITEM_SCORE_DIV, 1, ITEM_W, ITEM_H, scoreItem);
